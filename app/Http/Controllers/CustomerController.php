...
class CustomerController extends Controller {
    ...
    public function store(Request $request) {
        ...
        return redirect()->route('customers.index')->with('message', 'Dodano klienta poprawnie.');
    }
    ...
    public function destroy($id) {
        ...
        return redirect()->route('customers.index')->with('message', 'Usunięto klienta poprawnie.');
    }
}
